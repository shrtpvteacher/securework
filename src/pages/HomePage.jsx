  ...
  const steps = [
    {
      number: 1,
      title: 'Create Job',
      description: 'Define requirements and deposit funds into smart contract escrow'
    },
    {
      number: 2,
      title: 'Freelancer Accepts',
      description: 'Worker accepts terms and receives NFT representing their role'
    },
    {
      number: 3,
      title: 'Work Submission',
      description: 'Freelancer uploads completed work for AI verification'
    },
    {
      number: 4,
      title: 'AI Verification',
      description: 'AI reviews work against original requirements'
    },
    {
      number: 5,
      title: 'Automatic Release',
      description: 'Funds released automatically upon successful verification'
    }
  ];
